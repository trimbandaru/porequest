		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PO Request",
									"targetURL": "#comncsporequestpoui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comncsporequestpoui-display": {
								"semanticObject": "comncsporequestpoui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ncs.porequest.poui",
									"url": sap.ui.require.toUrl("com/ncs/porequest/poui")
								}
							}
						}
					}
